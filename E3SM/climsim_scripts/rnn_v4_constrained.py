...
case_prefix = 'example_job_submit_nnwrapper_v4_constrained_rnn_prevtend_55290_ep18'
# exe_refcase = ''
...
#stop_opt,stop_n,resub,walltime = 'nmonths',60, 0,'40:00:00'
...
torch_model = '/storage/shared_e3sm/saved_models/wrapper/partiallystochasticRNN-Hidden_lr0.0005.neur144-144_xv4_yv5_num55290_ep18.pt'

#inputlength = 1525
#inputlength = 0
outputlength = 368
cb_nn_var_combo = 'v4_rnn'
input_rh = '.true.'
cb_spinup_step = 5
